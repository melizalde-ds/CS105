...
public class ArrayListDup {
    public static void main(String[] args) {
        ...
        do { // dw1 (Y/N)
            ...
            System.out.println("The following numbers were duplicated in the ArrayList: " + dups(numberList) + ".");
            do {// dw4 Repeat
    ...
    public static List<Integer> dups(List<Integer> numList) {
        List<Integer> rNumList = new ArrayList<Integer>();
        for (int i = numList.size() - 1; i > 0; i--) {
            if (numList.subList(0, i).contains(numList.get(i))) {
                if (!rNumList.contains(numList.get(i))) {
                    rNumList.add(numList.get(i));
                }
            }
        }
        return rNumList;
